...
public class ProfilePatient extends JFrame {
    ...
    public ProfilePatient(String pharmacistId) throws SQLException, ClassNotFoundException {
...
private void loadProfilePatient() throws SQLException, ClassNotFoundException {
    ...
    StringBuilder sql = new StringBuilder(
        "SELECT DISTINCT B.MABN, U.HOTENND, U.SDT, U.EMAIL, U.GIOITINH, U.NGAYSINH, U.DIACHI, " +
        "B.SOBHYT, B.LICHSU_BENHLY, B.DIUNG, B.NHOMMAU " +
        "FROM USERS U " +
