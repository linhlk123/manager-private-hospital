...
public class HisMedExam extends JFrame {
    private String patientId;
    private JTable historyTable;
    private JTextField tfMaKham, tfMaLich, tfMaBS, tfMaDT, tfNgayKham, tfNgayTaiKham;
    private DefaultTableModel model;

    public HisMedExam(String patientId) throws SQLException, ClassNotFoundException {
        ...
        btnMed.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    ...
                    Logger.getLogger(HisMedExam.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {   
                new HisMedExam("U002").setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(HisMedExam.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(HisMedExam.class.getName()).log(Level.SEVERE, null, ex);
