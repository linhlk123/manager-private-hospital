...
public class PrescriptionDoc extends JFrame {
    private String doctorId;
    private JTable prescriptionTable;
    private JTextField tfMaDT, tfMaDS, tfMaBN, tfNgayBan, tfThanhTien, tfTrangThaiTT;
    private DefaultTableModel model;

    public PrescriptionDoc(String doctorId) throws SQLException, ClassNotFoundException {
    ...
    private void initComponents() {
        ...
        btnSearch.addActionListener(e -> {
            try {
                ...
                Logger.getLogger(PrescriptionDoc.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void loadPrescription() throws SQLException, ClassNotFoundException {
        model.setRowCount(0);
        StringBuilder sql = new StringBuilder("SELECT * FROM DONTHUOC_DONTHUOCYC WHERE MABS = ?");
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {   
                new PrescriptionDoc("U001").setVisible(true);
            } catch (SQLException | ClassNotFoundException ex) {
                Logger.getLogger(PrescriptionDoc.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
