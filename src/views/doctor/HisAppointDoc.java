...
public class HisAppointDoc extends JFrame {
    private CardLayout cardLayout;
    private JPanel contentPanel;
    private String doctorId;
    
    public HisAppointDoc(String doctorId) throws SQLException, ClassNotFoundException {
...
//            });
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {   
                new HisAppointDoc("U001").setVisible(true);
