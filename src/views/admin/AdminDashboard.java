...
public class AdminDashboard extends JFrame {
    ...
    public AdminDashboard(String adminId) throws SQLException, ClassNotFoundException {
...
//        PersonalProfile profilePanel = new PersonalProfile(doctorId, () -> {
//            cardLayout.show(contentPanel, "MainFunctions");
...
//        Notification noti = new Notification(doctorId, () -> {
//            cardLayout.show(contentPanel, "MainFunctions");
//            sideMenu.setVisible(true); // <-- hiện lại menu khi bấm nút quay lại
//        });
//        return noti;
//    }
    ...
    private JPanel createMainFunctionPanel() {
        ...
        JPanel wrapper = new JPanel(new GridLayout(2, 4, 30, 30));
        wrapper.setPreferredSize(new Dimension(800, 400));
        ...
        wrapper.add(createFunctionContainer("Lịch sử khám bệnh", "src/views/patient/image/history.png"));
        wrapper.add(createFunctionContainer("Quản lí cấu hình hệ thống", "src/views/patient/image/drug.png"));
        wrapper.add(createFunctionContainer("Lịch sử bán thuốc", "src/views/patient/image/service.png"));
        ...
        JLabel welcomeLabel = new JLabel("CHÀO MỪNG ADMIN BỆNH VIỆN TƯ HEALINK!", SwingConstants.CENTER);
    ...
    private void handleMenuClick(String title) throws SQLException, ClassNotFoundException {
        ...
        switch (title) {
            ...
            case "Lịch sử khám bệnh" -> {
               System.out.println();
               new LichSuKhamBenh(adminId).setVisible(true);
            }
           case "Quản lí cấu hình hệ thống" -> {
                System.out.println(adminId);
                new SystemConfigEditor(adminId).setVisible(true);
            }
             case "Lịch sử bán thuốc" -> {
                 System.out.println(adminId);
                 new LichSuBanThuoc(adminId).setVisible(true);
             }
            ...
            case "Hồ sơ người dùng" -> {
                System.out.println(adminId);
                new ProfileUser(adminId).setVisible(true);
            }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {   
                new AdminDashboard("U002").setVisible(true);
            } catch (SQLException | ClassNotFoundException ex) {
