...
public class LichSuKhamBenh extends JFrame {
    private String patientId;
    private JTable historyTable;
    private JTextField tfMaKham, tfMaLich, tfMaBS, tfMaDT, tfNgayKham, tfNgayTaiKham, tfMaBN;
    private DefaultTableModel model;

    public LichSuKhamBenh(String patientId) throws SQLException, ClassNotFoundException {
    ...
    public LichSuKhamBenh() throws SQLException, ClassNotFoundException {
    this.patientId = null;
    setTitle("📄 Danh sách lịch sử khám bệnh (Admin)");
    setExtendedState(JFrame.MAXIMIZED_BOTH);
    setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
    ...
    private void initComponents() {
        ...
        btnMed.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    new Prescription(patientId).setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(LichSuKhamBenh.class.getName()).log(Level.SEVERE, null, ex);
        ...
        // ========== CÁC THÀNH PHẦN KHÁC ==========
        JPanel searchFieldsPanel = new JPanel(new GridLayout(3, 2, 15, 15));
        ...
        tfMaBN = new JTextField(); // tfMaBN là JTextField mới
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            try {   
                new LichSuKhamBenh().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(LichSuKhamBenh.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(LichSuKhamBenh.class.getName()).log(Level.SEVERE, null, ex);
